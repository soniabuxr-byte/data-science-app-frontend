...
export default function IPhone16Pro() {
  return (
    <div className="relative size-full" data-name="iPhone 16 Pro - 1">
      ...
      <p className="absolute font-['Post_No_Bills_Colombo_ExtraBold:Regular',sans-serif] leading-[56.016px] left-[201px] not-italic text-[#f5f9fa] text-[40px] text-center text-nowrap top-[404px] translate-x-[-50%]">Data Science App.com</p>
      <Button />
      <Button1 />
